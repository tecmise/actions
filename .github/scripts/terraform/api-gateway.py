    ...
    with open(filename, "w", encoding="utf-8") as f:
        ...
        if route.methods is not None:
            for method in route.methods:
                ...
                print(f"   source                                       = \"git::https://github.com/tecmise/actions//terraform/api-gateway-resource-verbs?ref=main\"", file = f)
                ...
                if (vpc_link_id is not None) and (not method.uri.startswith("__OPEN_ENDPOINT__")):
                    if method.name != "OPTIONS":
